...
func init() {
	router.MemberV1().GET("/settings/cani", handleGetSettingsGlobalCanI)
	router.MemberV1().GET("/settings", handleGetSettingGlobal)
	router.MemberV1().PUT("/settings", handleSettingsGlobalSave)
	router.MemberV1().GET("/settings/pinnedresources/cani", handleGetSettingsGlobalCanI)
	router.MemberV1().GET("/settings/pinnedresources", handleSettingsGetPinned)
	router.MemberV1().PUT("/settings/pinnedresources", handleSettingsSavePinned)
	router.MemberV1().DELETE("/settings/pinnedresources/:kind/:nameOrNamespace/:name", handleSettingsDeletePinned)
	router.MemberV1().DELETE("/settings/pinnedresources/:kind/:nameOrNamespace", handleSettingsDeletePinned)
}
