...
type MetricDataCell interface {
	...
	//todo GetResourceSelector() *metricapi.ResourceSelector
}
...
type DataSelector struct {
	...
	//todo CachedResources *metricapi.CachedResources
	...
	//todo CumulativeMetricsPromises metricapi.MetricPromises
	...
	//todo MetricsPromises metricapi.MetricPromises
}
