...
import {
    MultiCloudConfig, MultiCloudworkload, MultiCloudService, MultiCloudNamespace,
} from '@/pages/multicloud-resource-manage';
import {MultiCloudPropagationPolicy, MultiCloudOverridePolicy} from '@/pages/multicloud-policy-manage';
import {Helm, KarmadaConfig, Oem, Registry, Upgrade} from '@/pages/basic-config'
...
export function tranverseRoutes(route: RouteObject, paths: string[] = []) {
    ...
    if (!route.children) {
        ...
        route.children
            .forEach(child => tranverseRoutes(child, newPaths))
    }
}
